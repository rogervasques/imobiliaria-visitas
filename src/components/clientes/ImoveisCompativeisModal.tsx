          ...
          <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
            ...
            {imoveis.map((imovel) => {
              ...
              return (
                <div
                  key={imovel.id}
                  className="p-3 sm:p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs hover:border-emerald-500/50 hover:shadow-md transition-all flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between"
                >
                  {/* Foto e Detalhes */}
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800">
                    ...
                    {onAgendarVisita && (
                      <Button
                        ...
                        variant="primary"
                        size="sm"
                        onClick={() => onAgendarVisita(cliente, imovel)}
